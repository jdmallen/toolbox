...
/// <summary>
/// Defines a specification pattern for querying entities with criteria, includes, ordering, and paging.
...
public interface ISpecification<T>
{
	...
	/// <summary>
	/// Gets the collection of related entities to eagerly load using expression-based includes.
	/// </summary>
	IEnumerable<Expression<Func<T, object>>> Includes { get; }

	/// <summary>
	/// Gets the collection of related entities to eagerly load using string-based navigation paths.
	/// </summary>
