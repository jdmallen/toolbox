...
{
	/// <summary>
	/// Configures the SQLite-specific entity model using the Entity Framework Core ModelBuilder.
	/// </summary>
...
/// <summary>
/// Base class for SQLite-specific complex entity models with custom primary key type
