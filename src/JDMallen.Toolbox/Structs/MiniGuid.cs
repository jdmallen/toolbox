		...
		IEquatable<Guid>
{
	...
	/// <summary>
	/// Initializes a new instance of the <see cref="MiniGuid"/> struct from an encoded string representation.
	/// </summary>
	...
	/// <summary>
	/// Initializes a new instance of the <see cref="MiniGuid"/> struct from a standard GUID.
	/// </summary>
	...
	/// <returns>The decoded GUID, or <see cref="Guid.Empty"/> if the value is null or whitespace.</returns>
	...
	/// </summary>
	/// <param name="obj">The object to compare to.</param>
	/// <returns>true if obj is a MiniGuid, Guid, or string that represents an equal value; otherwise, false.</returns>
