...
public class ProblemDetailsResultsTests
{
	...
	{
		ProblemHttpResult result = ProblemDetailsResults.BadRequest("The payload was malformed.");
	...
	{
		ProblemHttpResult result = ProblemDetailsResults.Conflict("That name is already taken.");
	...
	{
		ProblemHttpResult result = ProblemDetailsResults.Forbidden("You may not touch this.");
	...
	{
		ProblemHttpResult result = ProblemDetailsResults.NotFound(
	...
	{
		ProblemHttpResult result = ProblemDetailsResults.InternalServerError("Something broke.");
	...
	{
		ProblemHttpResult result = ProblemDetailsResults.NotFound("Gadget 7 was not found.");
